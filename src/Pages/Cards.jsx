        ...
        <div id="services-list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white text-black w-full shadow-xl p-6 rounded-lg transition-transform hover:shadow-2xl hover:scale-105 ">
            ...
            <div className="flex flex-col gap-5 mt-4">
              <h2 className=" flex justify-end text-xl font-semibold text-black">حجز دكتور</h2>
              ...
              <div className="flex justify-end">
                <button className="bg-[#00325f] text-white px-4 py-2 rounded-full hover:bg-[#d68d13] transition-colors w-full  h-14">تواصل</button>
              </div>
            </div>
          </div>
